        ...
        <div class="widget-content nopadding">
          <form action="crud/guru/update.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="control-group">
              <label class="control-label">Tempat Lahir :</label>
              <div class="controls">
                <input type="text" name="tmpt_lahir" value="<?php echo $data['tmpt_lahir'] ?>" class="span11" placeholder="Tempat Lahir" required />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Tanggal Lahir :</label>
        ...
        <div class="widget-content nopadding">
          <form action="crud/siswa/create.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="control-group">
              <label class="control-label">Tempat Lahir :</label>
              <div class="controls">
                <input type="text" name="tmpt_lahir" class="span11" placeholder="Tempat Lahir" required />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Tanggal Lahir :</label>
